...
async def test_v02_full_life_cycle():
    """Verify the complete agent lifecycle: from social activation to sleep."""
    # Environment setup
    agent_a_id = "agent_a"
    agent_b_id = "agent_b"
    ...
    # Verify transition to cognitive processing state
    ...
    async with AsyncSessionLocal() as session:
        ...
        # Verify experiential node persistence
